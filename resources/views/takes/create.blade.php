...
@section('content')
    <div class="container">
        <h3>Add Takes</h3>
        <hr>
        <form action="{{ route('takes.store') }}" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" name="mark" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter mark">
            </div>
